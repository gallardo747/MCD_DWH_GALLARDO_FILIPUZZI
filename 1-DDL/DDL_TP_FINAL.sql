...
------------------------------------------------------------------------------------------------
 ...
 -- Agrego CAMPOS DE AUDITORIA ROWID
 
 
ALTER TABLE [STG].[LK_CATEGORIES] ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [STG].[LK_CUSTOMER_DEMOGRAPHICS] ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [STG].[LK_CUSTOMERS] ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [STG].[LK_EMPLOYEES] ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [STG].[LK_EMPLOYEES_TERRITORIES] ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [STG].[LK_ORDERS]  ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [STG].[LK_ORDERS_DETAILS]   ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [STG].[LK_PRODUCTS]   ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [STG].[LK_REGIONS]    ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [STG].[LK_REL_CUSTOMERS_CUSDEMO]     ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [STG].[LK_SHIPPERS]     ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [STG].[LK_SUPPLIERS]     ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [STG].[LK_SUPPLIERS_DATOS_Contacto]     ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [STG].[LK_TERRITORIES]     ADD AUD_ROWID VARBINARY(16) NOT NULL;

CREATE TABLE [STG].[LK_COUNTRIES](
	[Country_CD] [varchar](10) NOT NULL,
	[Country_Name] [varchar](50) NOT NULL,
	[AUD_INSERT_DT] [datetime] NOT NULL,
	[AUD_USER_INSERT] [varchar](50) NOT NULL,
	[AUD_ACTION] [varchar](50) NOT NULL,
	[AUD_ROWID] [varbinary](16) NOT NULL
) ON [PRIMARY]
GO

ALTER TABLE [DWH].[LK_CATEGORIES] ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [DWH].[LK_CUSTOMER_DEMOGRAPHICS] ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [DWH].[LK_CUSTOMERS] ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [DWH].[LK_EMPLOYEES] ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [DWH].[LK_EMPLOYEES_TERRITORIES] ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [DWH].[LK_ORDERS]  ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [DWH].[LK_ORDERS_DETAILS]   ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [DWH].[LK_PRODUCTS]   ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [DWH].[LK_REGIONS]    ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [DWH].[LK_REL_CUSTOMERS_CUSDEMO]     ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [DWH].[LK_SHIPPERS]     ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [DWH].[LK_SUPPLIERS]     ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [DWH].[LK_SUPPLIERS_DATOS_Contacto]     ADD AUD_ROWID VARBINARY(16) NOT NULL;
ALTER TABLE [DWH].[LK_TERRITORIES]     ADD AUD_ROWID VARBINARY(16) NOT NULL;